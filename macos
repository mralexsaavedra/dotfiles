...
sudo scutil --set ComputerName "MacBook mralexsaavedra"
sudo scutil --set HostName "MacBook mralexsaavedra"
sudo scutil --set LocalHostName "MacBook mralexsaavedra"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "MacBook mralexsaavedra"
